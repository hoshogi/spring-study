...
public class TokenProvider implements InitializingBean {
    ...
    // 빈이 생성되고 의존성 주입까지 끝낸 이후에 주입받은 secret 값을 base64 decode하여 key 변수에 할당
    @Override
    ...
    public String createToken(Authentication authentication) {
        ...
        Date validity = new Date(now + this.tokenValidityInMilliseconds); // application.yml에서 정의한 토큰 만료시간 설정
